  ...
  public static class FactoryFromBinder0Extensions
  {
      ...
      where TMemoryPool : MemoryPool<IMemoryPool, TContract>
    {
      ...
      fromBinder.ProviderFunc =
        container =>
        {
          return new PoolableMemoryPoolProvider<TContract, TMemoryPool>(container, poolId);
        };
    ...
    {
      return fromBinder
        .FromPoolableMemoryPool<TContract, PoolableMemoryPool<IMemoryPool, TContract>>(poolBindGenerator);
    }
      ...
      Action<ConcreteBinderGeneric<IFactory<TContract>>> factoryBindGenerator)
    {
      ...
      fromBinder.ProviderFunc =
        container =>
        {
          return new IFactoryProvider<TContract>(container, factoryId);
        };
