    ...
    : FactorySubContainerBinderWithParams<TContract>
  {
        ...
        installerMethod)
    {
      ...
      ProviderFunc =
        container => new SubContainerDependencyProvider(
          ...
          new SubContainerCreatorByMethod<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TParam8,
            TParam9, TParam10>(
        ...
        installerMethod)
    {
      ...
      ProviderFunc =
        container => new SubContainerDependencyProvider(
          ContractType, SubIdentifier,
          new SubContainerCreatorByNewGameObjectMethod<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7,
            TParam8, TParam9, TParam10>(container,
        ...
        installerMethod)
    {
      ...
      ProviderFunc =
        container => new SubContainerDependencyProvider(
          ContractType, SubIdentifier,
          new SubContainerCreatorByNewPrefabMethod<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7,
            TParam8, TParam9, TParam10>(container,
